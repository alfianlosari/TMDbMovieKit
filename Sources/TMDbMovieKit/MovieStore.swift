...
public class MovieStore {
    ...
    public func fetchMovies(from endpoint: MovieEndpoint, params: [String: String]? = nil, successHandler: @escaping (_ response: MoviesResponse) -> Void, errorHandler: @escaping(_ error: Error) -> Void) {
